...
<html>
	<head>
		 ...
		 */"src/main/webapp/WEB-INF/views/mqtt/mqttIotCore.js"
		function add_common_mqtt_arguments(yargs) {
		    yargs
		        .option('endpoint', {
		            alias: 'e',
		            description: 'a6v8vus1k5k5m-ats.iot.ap-northeast-2.amazonaws.com',
		            type: 'string',
		            required: true
		        })
		        .option('ca_file', {
		            alias: 'r',
		            description: "src/main/webapp/WEB-INF/views/mqtt/sec/AmazonRootCA1.pem",
		            type: 'string',
		            required: false
		        })
		        .option('client_id', {
		            alias: 'C',
		            description: 'c2c-client',
		            type: 'string',
		            required: false
		        })
		}
		...
		function add_direct_tls_connect_arguments(yargs, is_required=false) {
		    yargs
		        .option('cert', {
		            alias: 'c',
		            description: "src/main/webapp/WEB-INF/views/mqtt/sec/device.pem.crt",
		            type: 'string',
		            required: is_required
		        })
		        .option('key', {
		            alias: 'k',
		            description: "src/main/webapp/WEB-INF/views/mqtt/sec/private.pem.key",
		            type: 'string',
		            required: is_required
		        })
		}
